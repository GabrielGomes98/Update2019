...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            {
                return; //Verifica se as classes ja estão com algum dado, caso ja esteja, nada será feito.
            }
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@hotmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            ...
            SalesRecord r31 = new SalesRecord(31, new DateTime(2017, 05, 3), 20000.0, SaleStatus.Billed, s1);
